...
export function CheckForUpdates():Promise<updater.UpdateStatus>;
...
export function GetNotifications():Promise<Array<notification.Notification>>;
...
export function GetUnreadNotifications():Promise<Array<notification.Notification>>;
